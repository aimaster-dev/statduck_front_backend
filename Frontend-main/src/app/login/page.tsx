...
const LoginPage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:pt-20 pr-10 pl-10">
                ...
                <form onSubmit={handleSubmit} className="grid gap-4">
                    ...
                    <div className="grid gap-2 mt-4">
                        <span className="text-sm text-gray-700 dark:text-gray-300">
                            You do not have an account? <Link href="/signup" legacyBehavior><a className="text-blue-500 dark:text-blue-400 font-medium">Sign up</a></Link>
                        </span>
                    </div>
                </form>
            </div>
