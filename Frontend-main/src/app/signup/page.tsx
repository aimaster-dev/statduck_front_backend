...
import { AiOutlineGoogle, AiOutlineWallet } from 'react-icons/ai';
import WalletConnectButton from '../wallet/page';
...
const SignUpPage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:pt-auto pl-20 pr-20">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md">
                <form onSubmit={handleSubmit} className="grid gap-4">
                    <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Sign Up Your Account</h3>
                    ...
                    {/* <div className="grid gap-2 mt-4">
                        <span className="text-sm text-gray-700 dark:text-gray-300">
                            Already Have an acount? <Link href="/login" legacyBehavior><a className="text-blue-500 dark:text-blue-400 font-medium">Log in</a></Link>
                        </span>
